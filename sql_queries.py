...
CREATE TABLE IF NOT EXISTS songplays (songplay_id int, start_time varchar, user_id int, level int, song_id int, artist_id int, session_id int, location varchar, user_agent varchar);
""")
...
artist_table_create = ("""
CREATE TABLE IF NOT EXISTS artists (artist_id int, name varchar, location varchar, latitude int, longitude int);
""")
